  ...
  class DocumentDesignsController < Design::ApplicationController
    ...
    def update
      if @document_design.update(document_design_params)
        ...
        redirect_to design.edit_theme_paper_size_document_design_path(@theme, @paper_size, @document_design), notice: "Document design updated."
      else
    ...
    def preview
      ...
      component = if result[:success]
        Design::Views::DocumentDesigns::Preview.new(
          ...
          jpg_url: design.preview_jpg_theme_paper_size_document_design_path(@theme, @paper_size, @document_design, t: Time.now.to_i),
    ...
    def panel
      ...
      render_paragraph_style_panel(
        style,
        panel_update_url: design.panel_update_theme_paper_size_document_design_path(@theme, @paper_size, @document_design, level: params[:level], style_id: style.id),
    ...
    def override
      ...
      render_paragraph_style_panel(
        style,
        panel_update_url: design.panel_update_theme_paper_size_document_design_path(@theme, @paper_size, @document_design, level: "document", style_id: style.id),
        revert_url: design.revert_theme_paper_size_document_design_paragraph_style_path(@theme, @paper_size, @document_design, style))
    end
    ...
    def new
      ...
      render_paragraph_style_panel(
        @paragraph_style,
        panel_update_url: design.theme_paper_size_document_design_paragraph_styles_path(@theme, @paper_size, @document_design),
        revert_url: nil)
    end
    ...
    def create
      ...
      if @paragraph_style.save
        ...
        render_paragraph_style_panel(
          @paragraph_style,
          panel_update_url: design.panel_update_theme_paper_size_document_design_path(@theme, @paper_size, @document_design, level: "document", style_id: @paragraph_style.id),
          revert_url: design.revert_theme_paper_size_document_design_paragraph_style_path(@theme, @paper_size, @document_design, @paragraph_style))
      else
        render_paragraph_style_panel(
          @paragraph_style,
          panel_update_url: design.theme_paper_size_document_design_paragraph_styles_path(@theme, @paper_size, @document_design),
    ...
    def document_style_revert_url(style, level)
      ...
      design.revert_theme_paper_size_document_design_paragraph_style_path(@theme, @paper_size, @document_design, style)
    end
    ...
    def build_style_urls
      ...
      @theme.base_paragraph_styles.each do |s|
        urls[s.name] = design.panel_theme_paper_size_document_design_path(@theme, @paper_size, @document_design, level: "theme", style_id: s.id)
      end
      @paper_size.paragraph_styles.each do |s|
        urls[s.name] = design.panel_theme_paper_size_document_design_path(@theme, @paper_size, @document_design, level: "paper", style_id: s.id)
      end
      @document_design.paragraph_styles.each do |s|
        urls[s.name] = design.panel_theme_paper_size_document_design_path(@theme, @paper_size, @document_design, level: "document", style_id: s.id)
      end
      urls
    end
