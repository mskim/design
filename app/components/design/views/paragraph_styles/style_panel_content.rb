    ...
    module ParagraphStyles
      ...
      class StylePanelContent < Design::Views::Base
        ...
        FIELDS = {
          ...
          "text_align"              => [ :select, "align", { options: %w[left center right justify], i18n: "text_align" } ],
          ...
          "fill_type"               => [ :select, "fill_type", { options: %w[none solid gradient], i18n: "fill_type" } ],
          "fill_gradient_direction" => [ :select, "gradient_dir",
                                         { options: %w[top_to_bottom bottom_to_top left_to_right right_to_left angle], i18n: "gradient_dir" } ],
          ...
          "corner_radius"           => [ :select, "corner_radius", { options: %w[none small medium large], i18n: "corner_radius" } ],
