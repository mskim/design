...
ActiveRecord::Schema[8.1].define(version: 2) do
  ...
  create_table "design_paragraph_styles", force: :cascade do |t|
    ...
    t.decimal "border_bottom_thickness"
    t.string "border_left_color"
    t.decimal "border_left_thickness"
    t.string "border_right_color"
    t.decimal "border_right_thickness"
    t.string "border_top_color"
    t.decimal "border_top_thickness"
    t.string "corner_bottom_left"
    t.string "corner_bottom_right"
    t.string "corner_top_left"
    t.string "corner_top_right"
    t.datetime "created_at", null: false
